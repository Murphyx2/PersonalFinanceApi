package com.app.domain.transaction.dto;

import java.io.Serial;
import java.io.Serializable;
import java.time.LocalDateTime;

import com.app.domain.budget.Budget;
import com.app.domain.category.Category;
import com.app.domain.currency.DefaultCurrencies;
...
public class TransactionDTO implements Serializable {
	...
	public TransactionDTO withBudget(Budget budget) {
	...
	public TransactionDTO withCategory(Category category) {
